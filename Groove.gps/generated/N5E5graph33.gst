...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="s33">
        <node id="n15"/>
        <node id="n20"/>
        <node id="n27"/>
        <node id="n38"/>
        ...
        <edge from="n110" to="n15">
            <attr name="label">
                <string>edge</string>
            </attr>
        </edge>
        <edge from="n110" to="n53">
            <attr name="label">
                <string>edge</string>
            </attr>
        </edge>
